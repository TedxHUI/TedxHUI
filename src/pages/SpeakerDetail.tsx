        ...
        <div className="bg-gradient-to-br from-[#330609] via-black to-[#330609] min-h-screen">
            ...
            <section className="relative py-12 md:py-20 text-white min-h-[auto] lg:min-h-[70vh] flex items-center">
                <div className="container mx-auto px-6 relative z-10 w-fit">
                    ...
                    >
                    <Link to="/speakers" className="inline-flex items-center gap-2 text-white/80 hover:text-[#EA1D2C] text-sm md:text-base transition-colors group">
                    ...
                    <div className="flex-1 text-center md:text-left w-full">
                        ...
                        <div className="flex items-center gap-3 mb-3 font-medium">
                            ...
                            <span className="text-sm sm:text-base">Speaking at TEDxHUI 2026</span>
                        </div>
                        ...
                        <div className="flex items-center gap-3 font-medium">
                            ...
                            Ilorin, Kwara State, Nigeria • Feb 05, 2026
                            </span>
                        </div>
                        </motion.div>
                        ...
                        >
                        <a href={speaker.instagram} className="hover:scale-110 active:scale-95 transition-all">
                            <img src="/images/icons/ig.svg" alt="Instagram" className='w-10 h-10 sm:w-12 sm:h-12' />
                        </a>
                        <a href={speaker.linkedin} className="hover:scale-110 active:scale-95 transition-all">
                            <img src="/images/icons/linkedln.svg" alt="LinkedIn" className='w-10 h-10 sm:w-12 sm:h-12' />
                        </a>
                        </motion.div>
                    </div>
                    </div>
            ...
            <section className="py-16 md:py-24 bg-white text-[#040001]">
                <div className="container mx-auto px-6 max-w-4xl">
                    ...
                    >
                        About  
                        <span className="text-[#EA1D2C]"> {speaker.name.split(' ')[0]}</span>
                    </motion.h2>
