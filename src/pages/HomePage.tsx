...
const HomePage = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "Smart casual or business casual is recommended. Be comfortable but polished.",
    },
    {
      question: "Will food and refreshments be provided?",
      answer:
        " Yes. Snacks and refreshments will be available, with special perks for Inspire and Legacy ticket holders.",
    },
    {
      question: "Why should I attend TEDxHUI?",
      answer:
        "Because TEDxHUI is more than just an event, it’s an experience. You’ll connect with brilliant minds, hear powerful stories, and walk away with fresh perspectives that can spark change in your own life and community.",
    },
    {
      question: "What inspires the theme “The Gift”?",
      answer:
        "Our theme, “The Gift,” reflects the idea that every idea, every story, and every individual has something unique to offer the world. TEDxHUI is about unwrapping those gifts, sharing knowledge, experiences, and insights that can inspire transformation.",
    },
    {
      question: "Who can attend TEDxHUI?",
      answer:
        "Anyone who believes in the power of ideas! Students, professionals, entrepreneurs, creatives, and community members are all welcome.",
    },
    {
      question: "What will I gain from attending?",
      answer:
        "Expect to gain new insights, meet like-minded people, discover opportunities for collaboration, and leave inspired to take action in your personal or professional life.",
    },
    {
      question: "How does TEDxHUI benefit our community?",
      answer:
        "By showcasing voices and ideas from within and beyond our community, TEDxHUI serves as a catalyst for dialogue, growth, and innovation that ripple far beyond the event itself.",
    },
  ];
      ...
      <section className="relative max-h-screen bg-gradient-to-br from-[#330609] via-[#000000] to-[#330609] text-white overflow-hidden pb-[80px]">
        ...
        <div className="container px-[3.5rem] py-[7rem] relative z-10">
          <div className="max-w-5xl text-center sm:text-start ">
            ...
            >
              An independently organized TED event uniting thinkers, leaders,
              and creatives to share stories that inspire change.
            </motion.p>
      ...
      <section className="py-[3rem] md:py-[4rem] bg-white overflow-hidden">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div
              className={`space-y-10 md:space-y-12 mt-12 p-9 rounded-[30px] bg-[#FEF4F4]`}
            >
              <div className="space-y-3">
                ...
                <p className="text-sm md:text-base text-gray-700 leading-relaxed">
                  There are some days that just change you, and TEDxHUI is one
                  of them. It's not another event where you sit, clap, and go
                  home, it's an experience that rewires something inside you.
                  You'll hear people your age, and people way beyond your age,
                  share real stories of failure, faith, and breakthroughs. And
                  suddenly, it hits you: “Wait, maybe I can do that too.”You'll
                  leave with new dreams, new energy, and that spark that
                  whispers — “my time starts now.
                </p>
              </div>
            </div>

            <div
              className={`space-y-10 md:space-y-12 mt-[100px] p-9 rounded-[30px] bg-[#F1FAEE]`}
            >
              <div className="space-y-3">
                <h3 className="text-xl md:text-2xl font-bold text-black">
                ...
                <p className="text-sm md:text-base text-gray-700 leading-relaxed">
                  Let's be real, the world runs on connections. And at TEDxHUI,
                  you'll find the kind of people who light you up. People who
                  think boldly, dream wildly, and act intentionally. You'll meet
                  techies, creatives, entrepreneurs, and deep thinkers, all in
                  one room. The person you bump into at the snack table could be
                  your next collaborator, co-founder, or someone who just gets
                  you. You don't want to hear about this from others later, be
                  there to live it.
                </p>
              </div>
            </div>
            ...
            <div
              className={`space-y-10 md:space-y-12 mt-[100px] p-9 rounded-[30px] bg-[#FDF6EC]`}
            >
              <div className="space-y-3">
                <h3 className="text-xl md:text-2xl font-bold text-black">
                ...
                <p className="text-sm md:text-base text-gray-700 leading-relaxed">
                  This year's theme, The Gift, isn't just poetic, it's personal.
                  It's about realizing that you already have something within
                  you that the world needs. You are the story. The idea. The
                  spark. The gift. TEDxHUI isn't here to give you something new,
                  it's here to help you unwrap what's already yours. The talks,
                  the energy, the people, everything is designed to remind you
                  that you matter, your ideas matter, and the world is waiting
                  to hear from you.
                </p>
              </div>
            </div>
            ...
            <div
              className={`space-y-10 md:space-y-12 mt-[100px] p-9 rounded-[30px] bg-[#F4F8F1]`}
            >
              <div className="space-y-3">
                <h3 className="text-xl md:text-2xl font-bold text-black">
                ...
                <p className="text-sm md:text-base text-gray-700 leading-relaxed">
                  There's something about a TEDx crowd, the electricity, the
                  heartbeat, the shared excitement of hearing something powerful
                  for the first time. When the lights dim and that red dot
                  glows, you'll feel the energy shift. Every word, every
                  performance, every cheer it pulls you in. The cameras can't
                  capture that feeling; only being there can. You'll laugh,
                  reflect, maybe tear up a little and when you leave, you'll
                  wish you could rewind it all.
                </p>
              </div>
            </div>

            <div
              className={`space-y-10 md:space-y-12 mt-[100px] p-9 rounded-[30px] bg-[#FFF9F1]`}
            >
              <div className="space-y-3">
                <h3 className="text-xl md:text-2xl font-bold text-black">
                ...
                <p className="text-sm md:text-base text-gray-700 leading-relaxed">
                  TEDxHUI isn't just a one-day event; it's a movement that
                  outlives the day itself. The friendships you build, the
                  lessons you take, and the ideas you'll share after, that's the
                  real story. When you attend, you're not just watching change
                  you become part of it. You become one of the people who can
                  proudly say, “I was there when it all began.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="pt-16 md:pt-[3rem] bg-white overflow-hidden">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            >
              Our <span className="text-[#EA1D2C]">Amazing</span> Sponsors and
              Partners
            </motion.h2>
                ...
                {tickerSponsors.map((sponsor, index) => (
                  <motion.div
                    ...
                    whileHover={{
                      ...
                      filter:
                        "drop-shadow(0px 10px 15px rgba(234, 29, 44, 0.2))",
                    }}
              ...
              <div key={index} className="flex flex-col space-y-4">
                ...
                <div className="flex justify-start w-full relative">
                  ...
                  >
                    ...
                    <div
                      className={`absolute top-0 -left-2 w-0 h-0 border-t-[10px] border-r-[10px] border-r-transparent ${
                        activeId === index
                          ? "border-t-[#FEEBEC]"
                          : "border-t-[#040001]"
                      }`}
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          >
            ...
            <div className="relative z-10 max-w-[30rem] space-y-6">
              ...
              >
                Be Part of the{" "}
                <span className="text-white">TEDxHUI Community</span>
              </motion.h2>
              ...
              >
                Be part of a vibrant network of thinkers and innovators shaping
